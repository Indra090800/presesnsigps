...
@section('content')
    <div class="row" style="margin-top: 4rem;">
        <div class="col">
            <form action="/izincuti/{{ $ic->id_izin }}/fedit" method="POST" id="frmizin">
                @csrf
                <div class="form-group">
                    <input type="text" value="{{ $ic->tgl_izin_dari }}" class="form-control datepicker" autocomplete="off" placeholder="Dari" id="dari" name="tgl_izin_dari">
                </div>
                <div class="form-group">
                    <input type="text" value="{{ $ic->tgl_izin_sampai }}" class="form-control datepicker" autocomplete="off" placeholder="Sampai" id="sampai" name="tgl_izin_sampai">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <select name="kode_cuti" id="kode_cuti" class="form-control selectmaterialize">
                        <option value="{{ $ic->kode_cuti }}">{{ $ic->nama_cuti }}</option>
                        @foreach ($jcuti as $j)
                ...
                <div class="form-group">
                    <input type="text" value="{{ $ic->keterangan }}" name="keterangan" id="keterangan" placeholder="Keterangan" class="form-control">
