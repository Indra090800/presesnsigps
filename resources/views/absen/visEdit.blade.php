...
@section('content')
    <div class="row" style="margin-top: 4rem;">
        <div class="col">
            <form action="/izinsakit/{{ $is->id_izin }}/fedit" method="POST" id="frmizin" enctype="multipart/form-data">
                @csrf
                <div class="form-group">
                    <input type="text" value="{{ $is->tgl_izin_dari }}" class="form-control datepicker"
                        autocomplete="off" placeholder="Dari" id="dari" name="tgl_izin_dari">
                </div>
                <div class="form-group">
                    <input type="text" value="{{ $is->tgl_izin_sampai }}" class="form-control datepicker"
                        autocomplete="off" placeholder="Sampai" id="sampai" name="tgl_izin_sampai">
                </div>
                <div class="form-group">
                    <input type="text" class="form-control" placeholder="Jumlah Hari" id="jml_hari" name="jml_hari"
                        readonly>
                </div>
                @if ($is->sid != null)
                    <div class="row">
                ...
                <div class="form-group">
                    <input type="text" value="{{ $is->keterangan }}" name="keterangan" id="keterangan"
