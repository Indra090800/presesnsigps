        ...
        <div class="card">
            <div class="card-body text-center">
                <div class="list-menu">
                    ...
                    <div class="item-menu text-center">
                        <div class="menu-icon">
                            <a href="/ticket_qurban" class="primary" style="font-size: 40px;">
                                <ion-icon name="ticket-outline"></ion-icon>
                            </a>
                        </div>
                        <div class="menu-name">
                            <span class="text-center">Qurban</span>
                        </div>
                    </div>
                    <div class="item-menu text-center">
                        <div class="menu-icon">
            ...
            <div class="row">
                ...
                <div class="col-3">
                    <div class="card">
                        <div class="card-body text-center" style="padding: 12px  12px !important; line-height: 0.8rem;">
                            <span class="badge bg-danger"
                                style="position: absolute; top: 3px; right: 10px; font-size: 0.6rem; z-index: 999;">{{ $rekappengajuan->jmlizin != null ? $rekappengajuan->jmlizin : 0 }}</span>
                ...
                <div class="col-3">
                    <div class="card">
                        <div class="card-body text-center" style="padding: 12px  12px !important; line-height: 0.8rem;">
                            <span class="badge bg-danger"
                                style="position: absolute; top: 3px; right: 10px; font-size: 0.6rem; z-index: 999;">{{ $rekappengajuan->jmlsakit != null ? $rekappengajuan->jmlsakit : 0 }}</span>
                            ...
                            <li>
                                <div class="item">
                                    ...
                                    <div class="in">
                                        ...
                                        <span
                                            class="badge {{ $l->jam_in < '07:00' ? 'bg-success' : 'bg-danger' }}">{{ $l->jam_in }}</span>
                                    </div>
                                </div>
                            </li>
                        @endforeach
