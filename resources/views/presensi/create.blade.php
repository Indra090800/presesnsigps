...
@section('content')
    ...
    <div class="jam-digital-malasngoding">
        ...
        <p>Mulai : {{ date("H:i", strtotime($jamkerja->awal_jam_in)) }}</p>
        <p>Masuk : {{ date("H:i", strtotime($jamkerja->jam_masuk)) }}</p>
        <p>Akhir : {{ date("H:i", strtotime($jamkerja->akhir_jam_in)) }}</p>
...
@push('myscript')
    <script>
        ...
        function successCallback(position){
            ...
            var circle = L.circle([lat_kantor, longi_kantor], {
                color: 'red',
                fillColor: '#f03',
                fillOpacity: 0.5,
                radius: radius
