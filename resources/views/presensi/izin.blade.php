                    ...
                    <div class="card-body">
                        <div class="historycontent">
                            <div class="iconpresensi">
                                ...
                                @if ($h->status == 'i')
                                    <svg xmlns="http://www.w3.org/2000/svg"
                                        class="icon icon-tabler icon-tabler-file-description" width="48" height="48"
                                ...
                                @elseif ($h->status == 's')
                                    <svg xmlns="http://www.w3.org/2000/svg"
                                        class="icon icon-tabler icon-tabler-report-medical" width="48" height="48"
                                        viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                                        stroke-linecap="round" stroke-linejoin="round">
                                        <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                        <path
                                ...
                                @elseif ($h->status == 'c')
                                    <svg xmlns="http://www.w3.org/2000/svg"
                                        class="icon icon-tabler icon-tabler-briefcase-off" width="48" height="48"
                                        viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                                        stroke-linecap="round" stroke-linejoin="round">
                                        <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                        <path
                            ...
                            <div class="datapresensi">
                                <h3 style="line-height: 3px">{{ date('d-m-Y', strtotime($h->tgl_izin_dari)) }}
                                    ({{ $status }})
                                </h3>
                                <small>{{ date('d-m-Y', strtotime($h->tgl_izin_dari)) }} s/d
                                    {{ date('d-m-Y', strtotime($h->tgl_izin_sampai)) }}</small>
                                <p>
                            ...
                            <div class="status">
                                ...
                                <p style="margin-top: 5px; font-weight: bold;">
                                    {{ hitunghari($h->tgl_izin_dari, $h->tgl_izin_sampai) }} hari</p>
                            </div>
                        </div>
                    </div>
                </div>
