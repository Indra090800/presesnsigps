                                ...
                                <table class="table table-sthiped table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if ($p->status_approved == 0)
                                                <a href="#" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#edit{{ $p->id_izin }}">
                                                ...
                                                @else
                                                <a href="/batalkan/{{ $p->id_izin }}" class="btn btn-danger btn-sm">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-edit" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                                    <path d="M7 7h-1a2 2 0 0 0 -2 2v9a2 2 0 0 0 2 2h9a2 2 0 0 0 2 -2v-1"></path>
                                                    <path d="M20.385 6.585a2.1 2.1 0 0 0 -2.97 -2.97l-8.415 8.385v3h3l8.385 -8.415z"></path>
                                    ...
                                    <div class="row">
                                        <div class="col-3">
                                            <div class="input-icon mb-3">
                                                ...
                                                <input type="text" value="{{ Request('nik') }}" name="nik" class="form-control" placeholder="NIK" id="nik">
                                            </div>
                                        </div>
                                        <div class="col-3">
                                            <div class="input-icon mb-3">
...
@foreach ($pengajuan as $p)
<div class="modal modal-blur fade" id="edit{{ $p->id_izin }}" tabindex="-1" role="dialog" aria-hidden="true">
